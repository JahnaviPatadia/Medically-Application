...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed pr-20 top-0 left-0 z-30 h-full w-72 bg-darkgray text-white overflow-y-auto transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="bg-[#E2F3F2] mr-12 h-full">
          ...
          <div className="">
            <nav className="mt-6">
              <ul className="flex flex-col gap-1">
                ...
                <li>
                  <NavLink
                    to="/admin/dashboard/patient"
                    className="flex text-black items-center py-3 px-6 transition duration-200 hover:bg-[#005c69] hover:text-white  text-lg"
                    onClick={() => setIsOpen(false)}
                  >
                    <IoPerson className="mr-4 size={26}" />

                    <p className="text-base">Patient</p>
                  </NavLink>
                </li>
                <li>
                  <NavLink
                    ...
                    onClick={() => setIsOpen(false)}
                  >
                    <GoPersonFill className="mr-4 size={26}" />
