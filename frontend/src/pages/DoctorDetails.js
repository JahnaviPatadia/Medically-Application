...
const DoctorDetails = () => {
  return (
    <div>
      <p className="text-3xl font-bold text-center mt-4">Profile</p>
      ...
      <div className="flex gap-4 mt-6">
        ...
        <div className="w-1/3">
          <p className="pr-40 text-2xl font-semibold mt-2 pl-4 ">Details</p>
          <p className="flex">
            <p className="font-semibold pl-4 mr-2">Name: </p> Willion Peterson
          </p>
          <p className="flex ">
            <p className="font-semibold pl-4 mr-2">Experience: </p> 25 Years
          </p>
          <p className="flex ">
            <p className="font-semibold pl-4 mr-2">Degree:</p> MD in
            Dermatologies
          </p>

          <p className="flex">
            <p className="font-semibold pl-4 mr-2">Age: </p> 55 Years
          </p>
          <p className="flex">
            <p className="font-semibold pl-4 mr-2">Contact Number: </p>{" "}
            1234567895
          </p>
          <p className="flex">
            <p className="font-semibold pl-4 mr-2">Timings: </p> Mon-Fri(10AM to
            7PM)
          </p>

          <p className="pl-20"> Sat(10AM to 1PM)</p>
