...
const DoctorSidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed pr-20 top-0 left-0 z-30 h-full w-90 bg-darkgray text-white overflow-y-auto transform transition-transform duration-300 ease-in-out ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        } md:translate-x-0`}
      >
        <button
          className="p-3 text-white md:hidden absolute top-0 left-0"
              ...
              <ul className="flex flex-col gap-1">
                <li>
                  ...
                  >
                    ...
                    <p className="text-base">Patient Records</p>
                  </NavLink>
                </li>
                <li>
                  <NavLink
                  ...
                  >
                    ...
                    <p className="text-base">Show Appointment</p>
                  </NavLink>
                </li>
